...
<html lang="en">
	...
	<body>
					...
					<div class="col-sm-4">
						<div class="panel">
							...
							<div class="panel-body">
								<img src="img/stud.jpg" alt="Item"/>
								<br/><br/>
								<p>Lifestyle store  is an American electronic commerce company with headquarters in Washington. It is the largest Internet-based retailer in the United States. E- Store started as an online blog, but soon diversified, selling mobile phones. E- Store also sells certain low-end products like USB cables and other accessories.
								Lifestyle Store has separate retail websites for United States, United Kingdom & Ireland, France, Canada, Germany, Italy, Spain, the Netherlands, Australia, Brazil, Japan, China, India and Mexico. Amazon also offers international shipping to certain other countries for some of its products.</p>
							</div>
						</div>
					</div>
					<div class="col-sm-4">
		...
		<div class="footer_menu">
			<div class="container">
				<div class="row" style="color:#999999;margin-bottom:5px;">
					<div class="col-lg-4" >
					...
					<div class="col-lg-4">
						...
						<div><a href="login.php" role="button" >Login</a></div>
						<div><a href="signup.php">Signup</a></div>
					</div>
					<div class="col-lg-4">
						<div><h3> <a href="contact.php">Contact Us</h3></div>
